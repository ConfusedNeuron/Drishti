...
- ✅ 253 unit tests passing on `feature/v4-f2-frontier` (not yet merged to `main`, which is separately at its own, lower count)
...
├── tests/                           # pytest — 193 tests passing (253 on feature/v4-f2-frontier, not yet merged)
